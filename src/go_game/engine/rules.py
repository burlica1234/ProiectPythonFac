...
class MoveResult:
    """
       Represents the result of applying a move to the board.

       Attributes:
           board: The resulting board position after the move is applied.
           captured: Number of stones captured by the move.
           captured_points: Points of stones removed from the board.
    """
    board: Board
    captured: int
...
def _check_bounds(board: Board, p: Point) -> None:
    """
        Validate that a point lies within the board bounds.
    """
